                ...
                <div class="event-speakers my-5">
                                      ...
                                      <div class="speaker-image">
                                          @if ($speaker->image)
                                              <img src="{{ asset('storage/' . $speaker->image) }}"
                                                  alt="{{ $speaker->name }}" class="img-fluid">
                                          @else
                                              <div class="img-fluid">
                  ...
                  @else
                      <div class="alert alert-light text-center py-4">
                          ...
                          <p class="mb-0">No speakers have been announced for this event yet.</p>
                      </div>
                  @endif
              </div>
                <div class="col-lg-8">
                    ...
                    @foreach ($recentEvents as $recentEvent)
                        <div class="post-item d-flex mb-4 pb-3 border-bottom">
                            ...
                            <div class="post-content">
                                <a href="{{ route('frontend.event.show', $recentEvent->id) }}"
