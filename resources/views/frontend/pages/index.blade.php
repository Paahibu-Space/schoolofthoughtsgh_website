                        ...
                        @foreach($upcomingEvents as $event)
                            <div class="swiper-slide">
                                <div class="event-card card-{{ $loop->iteration }}">
                                    <div class="event-img">
                                        <img
                                            src="{{ $event->image ? Storage::url($event->image) : asset('assets/images/event-default.png') }}"
                                            alt="{{ $event->title }}"
                                            class="img-fluid"
                                        />
                                    </div>
                                    <div class="event-content">
                                        ...
                                        <a href="{{ route('events.show', $event->id) }}" class="btn learn-btn">
                                            Learn More <i class="fas fa-arrow-right ms-2"></i>
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            @if($featuredBlogs->count() > 0)
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="blog-card h-100">
                                ...
                                <div class="blog-content p-4">
                                    ...
                                    <a href="{{ route('blogs.show', $blog->slug) }}" class="btn btn-outline-primary">
                ...
                <div class="text-center mt-5">
                    <a href="{{ route('frontend.blogs') }}" class="btn btn-primary">
                        View All Blog Posts
                    </a>
                </div>
            @else
