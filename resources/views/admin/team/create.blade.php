                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="btn-group w-100" role="group">
                                    <input type="radio" class="btn-check" name="is_active" id="active" value="1" {{ old('is_active', 1) ? 'checked' : '' }}>
                                    <label class="btn btn-outline-success w-50" for="active">Active</label>
                                    
                                    <input type="radio" class="btn-check" name="is_active" id="inactive" value="0" {{ old('is_active', 1) ? '' : 'checked' }}>
                ...
                <div class="col-lg-8">
                    <div class="form-section">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('role') is-invalid @enderror" id="role" name="role" placeholder="Role/Position" value="{{ old('role') }}" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" maxlength="500" placeholder="Brief description about this team member">{{ old('description') }}</textarea>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control social-input @error('linkedin_url') is-invalid @enderror" id="linkedin_url" name="linkedin_url" value="{{ old('linkedin_url') }}" placeholder="https://linkedin.com/in/username">
                                    @error('linkedin_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control social-input @error('instagram_url') is-invalid @enderror" id="instagram_url" name="instagram_url" value="{{ old('instagram_url') }}" placeholder="https://instagram.com/username">
                                    @error('instagram_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
