    ...
    <div class="card-header p-0 border-bottom-0">
        <div class="d-flex justify-content-between align-items-center p-3">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link {{ $filter == 'all' ? 'active' : '' }}" href="{{ route('admin.events.index', ['filter' => 'all']) }}">
                        All Events
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $filter == 'upcoming' ? 'active' : '' }}" href="{{ route('admin.events.index', ['filter' => 'upcoming']) }}">
                        Upcoming
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $filter == 'past' ? 'active' : '' }}" href="{{ route('admin.events.index', ['filter' => 'past']) }}">
                        Past
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $filter == 'featured' ? 'active' : '' }}" href="{{ route('admin.events.index', ['filter' => 'featured']) }}">
                        Featured
                    </a>
                </li>
            </ul>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">{{ Str::limit(strip_tags($event->description), 100) }}</p>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex justify-content-end">
                                    <a href="#" class="btn btn-sm btn-light me-1" data-bs-toggle="tooltip" title="View Details">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.events.edit', $event) }}" class="btn btn-sm btn-primary me-1" data-bs-toggle="tooltip" title="Edit Event">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $event->id }}" title="Delete Event">
