                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="vision-tab" data-bs-toggle="tab" data-bs-target="#vision" 
                                    type="button" role="tab" aria-controls="vision" aria-selected="false">Vision</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="impact-tab" data-bs-toggle="tab" data-bs-target="#impact" 
                                    type="button" role="tab" aria-controls="impact" aria-selected="false">Impact</button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content p-3 border border-top-0 rounded-bottom" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('general_content') is-invalid @enderror" 
                                              id="general_content" name="general_content" rows="5">{{ old('general_content', $generalSection->content ?? '') }}</textarea>
                            ...
                            <div class="tab-pane fade" id="mission" role="tabpanel" aria-labelledby="mission-tab">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('mission_content') is-invalid @enderror" 
                                              id="mission_content" name="mission_content" rows="5">{{ old('mission_content', $missionSection->content ?? '') }}</textarea>
                            ...
                            <div class="tab-pane fade" id="vision" role="tabpanel" aria-labelledby="vision-tab">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('vision_content') is-invalid @enderror" 
                                              id="vision_content" name="vision_content" rows="5">{{ old('vision_content', $visionSection->content ?? '') }}</textarea>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="alert alert-info">
                                            <p>You can add up to 4 impact items. The items will be displayed in the order shown below.</p>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody id="impact-items-table">
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="6" class="text-center">No impact items found.</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="mt-3">
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addImpactItemModal">
...
<div class="modal fade" id="addImpactItemModal" tabindex="-1" aria-labelledby="addImpactItemModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="icon" name="icon" value="fas fa-question" required readonly>
...
<div class="modal fade" id="editImpactItemModal" tabindex="-1" aria-labelledby="editImpactItemModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="edit_icon" name="icon" required readonly>
...
document.addEventListener('DOMContentLoaded', function() {
    /**
     * OPTION 3: COMPLETELY REPLACE BOOTSTRAP MODALS WITH MANUAL IMPLEMENTATION
     * 
     * If the previous solutions don't work, this more drastic approach
     * replaces Bootstrap's modal functionality with a simpler implementation
     * that doesn't rely on Bootstrap's focus trap.
     */
    ...
    const modalManager = {
        ...
        // Open a modal with a simple API
        open: function(modalId) {
            ...
            // Show backdrop if this is the first modal
        ...
        close: function(modalId) {
            ...
            // If no modals are open, remove backdrop and restore scrolling
            if (this.openModals.length === 0) {
                this.hideBackdrop();
    ...
    if (iconPickerBtn) {
        iconPickerBtn.addEventListener('click', function(e) {
            ...
            // Open the modal with our custom manager
            modalManager.open('iconPickerModal');
        });
    }
    ...
    if (editIconPickerBtn) {
        editIconPickerBtn.addEventListener('click', function(e) {
            ...
            // Pre-select the current icon if it exists
            populateIconGrid(faIcons);
    ...
    if (selectIconBtn) {
        selectIconBtn.addEventListener('click', function(e) {
            ...
            if (selectedIcon && currentTargetInput) {
                ...
                // Close the modal with our custom manager
                modalManager.close('iconPickerModal');
            }
        });
    }
    
    // Handle "Add New Impact Item" button
    const addImpactItemBtn = document.querySelector('button[data-bs-target="#addImpactItemModal"]');
    if (addImpactItemBtn) {
        addImpactItemBtn.addEventListener('click', function(e) {
            e.preventDefault();
            modalManager.open('addImpactItemModal');
        });
    }
    ...
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('edit-item') || e.target.closest('.edit-item')) {
            ...
            // Set form action
            editForm.action = `/admin/settings/about/impact-items/${id}/update`;
            ...
            // Show the modal with our custom manager
            modalManager.open('editImpactItemModal');
        }
    });
    ...
    // Make impact items table sortable (this code is unchanged)
    ...
    if (impactItemsTable) {
        new Sortable(impactItemsTable, {
            ...
            onEnd: function(evt) {
                ...
                const itemIds = Array.from(impactItemsTable.querySelectorAll('tr[data-id]')).map(row => row.dataset.id);
...
.icon-preview, .edit-icon-preview {
    min-width: 40px;
    text-align: center;
}
</style>
