...
@section('title', isset($institution) ? 'Edit Institution' : 'Add New Institution')
...
@section('content')
<form action="{{ isset($institution) ? route('admin.institutions.update', $institution) : route('admin.institutions.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-save me-2"></i>{{ isset($institution) ? 'Update' : 'Create' }} Institution
                        </button>
                        <a href="{{ route('admin.institutions.index') }}" class="btn btn-outline-secondary">
                            Cancel
                        </a>
